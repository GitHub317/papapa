...
#import "KJPhoneUtils.h"
#import <AddressBook/AddressBook.h>

static KJPhoneUtils *instance;

@implementation KJPhoneUtils

// 单列模式
+ (KJPhoneUtils *)shareManager
{
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[KJPhoneUtils alloc] init];
    });
    return instance;
}
...
{
    return [[KJPhoneUtils shareManager] addContactName:name phoneNum:num withLabel:label];
}
...
{
    return [[KJPhoneUtils shareManager] existPhone:phoneNum];
}
