...
#define Goods_MULTIPLE 628 / 750.0 
...
/**
 快速定义颜色
 */
#define COLORHex(colorStr) [UIColor colorWithHexString:colorStr]
...
#define VIEW_RECT_0_64 self.frame = RECT(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT - 64);       //自定义视图的frame宏
