...
typedef void(^KJPhotoKitManagerDimissBlock)(void);
...
@property (copy, nonatomic)  KJPhotoKitManagerDimissBlock dismissBlock;
@end
...
/**
 ...
 @param cancel 取消
 */
+ (void)showCameraInViewController:(UIViewController *)viewController sure:(void(^)(UIImage *image))sure cancel:(void(^)(void))cancel dimiss:(void(^)(void))dimiss {
    ...
    [KJPhotoKitManager shareManager].cancelBlock = cancel;
    [KJPhotoKitManager shareManager].dismissBlock = dimiss;
}
